...
function checkBoard() {
  for (let i = 0; i < winningArrays.length; i++) {
    ...
    //check thoose squares to see if they all have the class of player-one
    if (
    ...
    //check thoose squares to see if they all have the class of player-two
    if (
...
for (let i = 0; i < squares.length; i++) {
  squares[i].onclick = () => {
    // If the square below your square is taken you can go ontop of it
    if (
